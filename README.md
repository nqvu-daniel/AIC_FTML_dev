...
dataset_root/
  ...
  keyframes_intelligent/          # Generated intelligent samples  
    L21_V001/
      001.png 002.png ...
  meta/
    L21_V001.csv                  # Keyframe mapping (*.csv)
    L21_V001.json                 # Media metadata (*.json) 
    objects/
      L21_V001/
        001.json 002.json ...     # Object detection per frame
  features/
...
#### 1. Keyframe Mapping (`meta/L21_V001.csv`)
...
#### 2. Media Information (`meta/L21_V001.json`)
...
#### 3. Object Detection (`meta/objects/L26_V361/155.json`)  
...
**Structure:**
- File path: `meta/objects/{VIDEO_ID}/{FRAME_NUMBER}.json`
